...
| ![Morpho Katana 金库页](截图/Morpho-Katana-YearnOGETH-金库页-20260810.png) | **Yearn OG ETH**（`yOG-ETH`）`0x5920A6FC…141C` ｜ Network **Katana**（chainId 747474）｜ 投入 0.005 vbETH → 得 0.0049925 yOG-ETH ｜ 反推份额价格 **1.0014994 vbETH/share** ｜ 4 层嵌套（vbETH 是 agglayer 桥包装代币）｜ 🔴 与 Base 侧同协议但估值链路多一层 |
